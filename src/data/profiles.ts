import type { CompanyContext, ToneKey, ToneProfile } from "../domain/types.js";

export const toneProfiles: Record<ToneKey, ToneProfile> = {
  "direct-warm": {
    agentName: "Ari",
...
export const traitCopy: Record<string, string> = {
...
export const presets: Record<string, CompanyContext> = {
  robotics: {
